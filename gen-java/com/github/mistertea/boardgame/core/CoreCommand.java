...
public class CoreCommand implements org.apache.thrift.TBase<CoreCommand, CoreCommand._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CoreCommand");
  ...
  private static final org.apache.thrift.protocol.TField CHAT_FIELD_DESC = new org.apache.thrift.protocol.TField("chat", org.apache.thrift.protocol.TType.STRING, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new CoreCommandStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CoreCommandTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CoreCommand.class, metaDataMap);
  }
   ...
   */
  public CoreCommand(CoreCommand other) {
  ...
  public CoreCommand setPlayer(String player) {
    this.player = player;
    return this;
  }
  ...
  public CoreCommand setCreationTime(long creationTime) {
    this.creationTime = creationTime;
    setCreationTimeIsSet(true);
    return this;
  }
  ...
  public CoreCommand setType(int type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public CoreCommand setChat(String chat) {
    this.chat = chat;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CoreCommand)
      return this.equals((CoreCommand)that);
    return false;
  }

  public boolean equals(CoreCommand that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CoreCommand other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CoreCommand typedOther = (CoreCommand)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CoreCommand(");
    boolean first = true;
  ...
  private static class CoreCommandStandardSchemeFactory implements SchemeFactory {
    public CoreCommandStandardScheme getScheme() {
      return new CoreCommandStandardScheme();
    }
  }

  private static class CoreCommandStandardScheme extends StandardScheme<CoreCommand> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CoreCommand struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CoreCommand struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CoreCommandTupleSchemeFactory implements SchemeFactory {
    public CoreCommandTupleScheme getScheme() {
      return new CoreCommandTupleScheme();
    }
  }

  private static class CoreCommandTupleScheme extends TupleScheme<CoreCommand> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CoreCommand struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CoreCommand struct) throws org.apache.thrift.TException {
