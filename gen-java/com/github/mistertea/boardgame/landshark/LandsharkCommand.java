...
public class LandsharkCommand implements org.apache.thrift.TBase<LandsharkCommand, LandsharkCommand._Fields>, java.io.Serializable, Cloneable {
  ...
  public LandsharkCommand(LandsharkCommand other) {
    ...
    if (other.isSetHousePurchases()) {
      Map<String,Integer> __this__housePurchases = new HashMap<String,Integer>();
      for (Map.Entry<String, Integer> other_element : other.housePurchases.entrySet()) {

        String other_element_key = other_element.getKey();
        Integer other_element_value = other_element.getValue();

        String __this__housePurchases_copy_key = other_element_key;

        Integer __this__housePurchases_copy_value = other_element_value;

        __this__housePurchases.put(__this__housePurchases_copy_key, __this__housePurchases_copy_value);
      }
  ...
  public int compareTo(LandsharkCommand other) {
    ...
    LandsharkCommand typedOther = (LandsharkCommand)other;
    ...
    lastComparison = Boolean.valueOf(isSetHousePurchases()).compareTo(typedOther.isSetHousePurchases());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHousePurchases()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.housePurchases, typedOther.housePurchases);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
