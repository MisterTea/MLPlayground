...
public class PropertyGroup implements org.apache.thrift.TBase<PropertyGroup, PropertyGroup._Fields>, java.io.Serializable, Cloneable, Comparable<PropertyGroup> {
  ...
  public PropertyGroup(PropertyGroup other) {
    ...
    if (other.isSetMemberNames()) {
      Set<String> __this__memberNames = new HashSet<String>(other.memberNames);
  ...
  public int compareTo(PropertyGroup other) {
    ...
    lastComparison = Boolean.valueOf(isSetMemberNames()).compareTo(other.isSetMemberNames());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemberNames()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.memberNames, other.memberNames);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHousePrice()).compareTo(other.isSetHousePrice());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHousePrice()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.housePrice, other.housePrice);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
