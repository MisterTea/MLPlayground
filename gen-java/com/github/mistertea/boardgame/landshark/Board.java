...
public class Board implements org.apache.thrift.TBase<Board, Board._Fields>, java.io.Serializable, Cloneable {
  ...
  public Board(Board other) {
    ...
    if (other.isSetProperties()) {
      Map<String,Property> __this__properties = new HashMap<String,Property>();
    ...
    if (other.isSetPropertyOrder()) {
      List<String> __this__propertyOrder = new ArrayList<String>();
      for (String other_element : other.propertyOrder) {
        __this__propertyOrder.add(other_element);
      }
      this.propertyOrder = __this__propertyOrder;
    }
    this.startingMoney = other.startingMoney;
    if (other.isSetPropertyGroups()) {
      Map<String,PropertyGroup> __this__propertyGroups = new HashMap<String,PropertyGroup>();
  ...
  public int compareTo(Board other) {
    ...
    lastComparison = Boolean.valueOf(isSetPropertyOrder()).compareTo(typedOther.isSetPropertyOrder());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPropertyOrder()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.propertyOrder, typedOther.propertyOrder);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStartingMoney()).compareTo(typedOther.isSetStartingMoney());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStartingMoney()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.startingMoney, typedOther.startingMoney);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPropertyGroups()).compareTo(typedOther.isSetPropertyGroups());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPropertyGroups()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.propertyGroups, typedOther.propertyGroups);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
