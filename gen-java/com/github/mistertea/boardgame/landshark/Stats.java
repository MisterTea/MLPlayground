...
public class Stats implements org.apache.thrift.TBase<Stats, Stats._Fields>, java.io.Serializable, Cloneable {
  ...
  public Stats(Stats other) {
    if (other.isSetPropertyOwnerStats()) {
      Map<String,List<PropertyStats>> __this__propertyOwnerStats = new HashMap<String,List<PropertyStats>>();
      for (Map.Entry<String, List<PropertyStats>> other_element : other.propertyOwnerStats.entrySet()) {
        ...
        List<PropertyStats> __this__propertyOwnerStats_copy_value = new ArrayList<PropertyStats>();
    ...
    if (other.isSetPlayerStats()) {
      Map<String,PlayerStats> __this__playerStats = new HashMap<String,PlayerStats>();
  ...
  public int compareTo(Stats other) {
    ...
    Stats typedOther = (Stats)other;

    lastComparison = Boolean.valueOf(isSetPropertyOwnerStats()).compareTo(typedOther.isSetPropertyOwnerStats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPropertyOwnerStats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.propertyOwnerStats, typedOther.propertyOwnerStats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPlayerStats()).compareTo(typedOther.isSetPlayerStats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlayerStats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.playerStats, typedOther.playerStats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i99 = 0; _i99 < _map98.size; ++_i99)
                {
                  ...
                  List<PropertyStats> _val101; // required
                  _key100 = iprot.readString();
                  {
                    ...
                    {
                      PropertyStats _elem104; // required
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i116 = 0; _i116 < _map115.size; ++_i116)
          {
            ...
            List<PropertyStats> _val118; // required
            _key117 = iprot.readString();
            {
              ...
              {
                PropertyStats _elem121; // required
