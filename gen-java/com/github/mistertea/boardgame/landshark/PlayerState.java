...
public class PlayerState implements org.apache.thrift.TBase<PlayerState, PlayerState._Fields>, java.io.Serializable, Cloneable, Comparable<PlayerState> {
  ...
  public PlayerState(PlayerState other) {
    ...
    if (other.isSetProperties()) {
      Set<String> __this__properties = new HashSet<String>(other.properties);
  ...
  public int compareTo(PlayerState other) {
    ...
    lastComparison = Boolean.valueOf(isSetQuit()).compareTo(other.isSetQuit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQuit()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.quit, other.quit);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
