...
public class PropertyStats implements org.apache.thrift.TBase<PropertyStats, PropertyStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(PropertyStats other) {
    ...
    PropertyStats typedOther = (PropertyStats)other;
    ...
    lastComparison = Boolean.valueOf(isSetInvestment()).compareTo(typedOther.isSetInvestment());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInvestment()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.investment, typedOther.investment);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRevenue()).compareTo(typedOther.isSetRevenue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRevenue()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.revenue, typedOther.revenue);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
