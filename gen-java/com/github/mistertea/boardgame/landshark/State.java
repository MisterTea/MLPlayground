...
public class State implements org.apache.thrift.TBase<State, State._Fields>, java.io.Serializable, Cloneable {
  ...
  public State(State other) {
    ...
    if (other.isSetPlayerStates()) {
      List<PlayerState> __this__playerStates = new ArrayList<PlayerState>();
    ...
    if (other.isSetHouses()) {
      Map<String,Integer> __this__houses = new HashMap<String,Integer>();
      for (Map.Entry<String, Integer> other_element : other.houses.entrySet()) {

        String other_element_key = other_element.getKey();
        Integer other_element_value = other_element.getValue();

        String __this__houses_copy_key = other_element_key;

        Integer __this__houses_copy_value = other_element_value;

        __this__houses.put(__this__houses_copy_key, __this__houses_copy_value);
      }
    ...
    if (other.isSetDice()) {
      List<Integer> __this__dice = new ArrayList<Integer>();
      for (Integer other_element : other.dice) {
        __this__dice.add(other_element);
      }
  ...
  public int compareTo(State other) {
    ...
    lastComparison = Boolean.valueOf(isSetPlayerStates()).compareTo(typedOther.isSetPlayerStates());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlayerStates()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.playerStates, typedOther.playerStates);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHouses()).compareTo(typedOther.isSetHouses());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHouses()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.houses, typedOther.houses);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPlayerTurn()).compareTo(typedOther.isSetPlayerTurn());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlayerTurn()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.playerTurn, typedOther.playerTurn);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTurnState()).compareTo(typedOther.isSetTurnState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTurnState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.turnState, typedOther.turnState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAuctionState()).compareTo(typedOther.isSetAuctionState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAuctionState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.auctionState, typedOther.auctionState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDice()).compareTo(typedOther.isSetDice());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDice()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dice, typedOther.dice);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumDoubles()).compareTo(typedOther.isSetNumDoubles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumDoubles()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numDoubles, typedOther.numDoubles);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
